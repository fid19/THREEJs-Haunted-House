...
const ghosts1 = new THREE.PointLight('#0000ff', 2, 3) 
scene.add(ghosts1)

const ghosts2 = new THREE.PointLight('#ff00ff', 2, 3) 
scene.add(ghosts2)
...
const tick = () =>
{
    ...
    ghosts1.position.x = Math.cos(ghost1Angle) * 4
    ghosts1.position.z = Math.sin(ghost1Angle) * 4
    ghosts1.position.y = Math.sin(elapsedTime * 3)

    const ghost2Angle = - elapsedTime * 0.32
    ghosts2.position.x = Math.cos(ghost2Angle) * 4
    ghosts2.position.z = Math.sin(ghost2Angle) * 4
    ghosts2.position.y = Math.sin(elapsedTime * 3) + Math.sin(elapsedTime * 2.5)

    const ghost3Angle = - elapsedTime * 0.18
    ghosts3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.32))
    ghosts3.position.z = Math.sin(ghost3Angle) * (7 +Math.sin(elapsedTime *0.5))
    ghosts3.position.y = Math.sin(elapsedTime * 3) + Math.sin(elapsedTime * 2.5)
